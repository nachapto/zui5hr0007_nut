		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zui5hr0007_nut",
									"targetURL": "#zui5hr0007nut-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zui5hr0007nut-display": {
								"semanticObject": "zui5hr0007nut",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zui5hr0007nut",
									"url": sap.ui.require.toUrl("zui5hr0007nut")
								}
							}
						}
					}
